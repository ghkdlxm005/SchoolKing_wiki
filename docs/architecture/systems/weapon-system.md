...
| --- | --- | --- | --- | --- | --- | --- |
| **Compass** | 시작 무기·3점사 | 22 (헤드 2.0x) | 15 / 350 | 1.51s | burst 3 (간격 0.06) | 사거리 400 |
| **LegCrutch** | 자동 라이플 | 18 (헤드 1.8x) | 30 / 240 | 2.2s | auto ~13rps | 사거리 450, 2x 줌 |
| **Toaster** | 더블배럴 샷건 | 8 (헤드 1.5x) | 2 / 24 | 2.4s | semi | 사거리 120, 3단계 차지(우클릭) |
| **SiliconGun** | 레이저(램핑) | 틱 3→9 (2초 램프) | 100 에너지 / 300 | 1.8s | auto | **헤드 판정 없음**, 사거리 50 |

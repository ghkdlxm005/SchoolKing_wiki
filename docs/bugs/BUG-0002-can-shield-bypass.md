...
| 상태 | fixed (2026-06-26) |
| 심각도 | high |
| 관련 시스템 | [전투/데미지](../architecture/systems/combat/combat-damage-system.md), [무기](../architecture/systems/combat/weapon-system.md) |
...
→ 쉴드가 먼저 흡수되고 남은 만큼 체력 감소. ([ShieldSystem](../architecture/systems/combat/combat-damage-system.md))

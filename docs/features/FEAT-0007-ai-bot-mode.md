...
> **이 문서는 초기(2026-07-03) 버전이다.** 봇 시스템은 이후 10~42차에 걸쳐 완전히 재작성됐다(실제 무기 파지·3인칭 리깅·경로탐색·무기 성향·mood·동선 학습 등). 현재 상태는 [FEAT-0027 AI 봇 시스템 종합](./FEAT-0027-ai-bot-system.md) 참조. 이 문서는 기록 보존용.
